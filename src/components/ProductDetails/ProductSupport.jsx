...
function AccordionItem({ title, content }) {
  ...
  return (
    <li className="border border-b-[none] border-solid border-[#e1e1e1]">
      <a
        className={`cursor-pointer block leading-[35px] text-lg uppercase font-bold relative px-5 py-0 hover:bg-[#e0d8d3] hover:text-brown ${isOpen ? 'bg-[#e0d8d3] text-brown' : 'bg-[#42210b] text-white'}`}
            ...
            content={
              <div className="p-[20px] border-t-[#ebebeb] border-t border-solid opacity-1" id="profile" role="tabpanel">
                <p className="text-start">
                  <span className="text-base font-SVNFutura font-medium leading-normal text-gray-700">
                ...
                <p className="text-start">
                  <span className="text-base text-gray-700 font-SVNFutura font-medium">
                ...
                <p className="text-base text-gray-700 font-SVNFutura font-medium">
                ...
                <div className="w-full">
                  <img src="//bizweb.dktcdn.net/100/302/551/files/edited-download-1.jpg?v=1584990767436" alt="Image" className="w-full h-auto" />
                </div>

                <div className="w-full">
                  <img src="//bizweb.dktcdn.net/100/302/551/files/edited-download-copy.jpg?v=1584990860831" alt="Image" className="w-full h-auto" />
                </div>
                ...
                <p className="mt-6 text-base text-gray-700 font-SVNFutura font-medium">
                ...
                <table
                  ...
                  cellPadding={1}
                  cellSpacing={1}
                  className="w-full border-spacing-0 mb-[1em] border-collapse border border-solid border-[#42210b] mt-3 text-gray-700 font-SVNFutura font-medium"
                >
                  <tbody>
                    <tr>
                      <td>&nbsp;</td>
          ...
          <AccordionItem
            ...
            content={
              <div className="p-[20px] border-t-[#ebebeb] border-t border-solid opacity-1" id="messages4" role="tabpanel">
                ...
                <p className="text-base text-gray-700 font-SVNFutura font-medium">1 - Số lượng và loại đơn hàng</p>
                <p className="text-base text-gray-700 font-SVNFutura font-medium">
                ...
                <p className="text-base text-gray-700 font-SVNFutura font-medium">4 - Thời gian nhận hàng</p>
                <p className="text-base text-gray-700 font-SVNFutura font-medium">
